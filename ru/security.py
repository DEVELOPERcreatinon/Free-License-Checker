...
class SecurityManager:
    ...
    def _setup_encryption(self):
        ...
        if encryption_key == "CHANGE_THIS_TO_RANDOM_32_BYTES_BASE64":
            raise ValueError("Пожалуйста, измените ключ шифрования в config.json")
    ...
    def validate_key_format(self, key, license_type):
        """Проверка формата ключа с учетом префикса"""
        ...
        # Проверяем что оставшаяся часть состоит из допустимых символов
    ...
    def hash_key(self, key):
        """Хеширование ключа лицензии для безопасного хранения"""
